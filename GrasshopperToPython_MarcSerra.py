"""Provides a scripting component.
    Inputs:
        crvCount: [int] Number of curves
        yValue: [int] Y coordinate
        numSegments: [int] Number of divisions of each line
        density: [float] Density of mesh
        length: [float] Mesh faces lenght
    Output:
...
for line in lineList:
    ...
    params = rg.Curve.DivideByCount(curve,numSegments,True)
    for p in params:
...
mParams = rg.MeshingParameters(density,length)
mesh = rg.Mesh.CreateFromBrep(surface[0],mParams)
